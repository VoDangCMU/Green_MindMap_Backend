...
export class AddUserIdToLocations1762841730079 implements MigrationInterface {
    name = 'AddUserIdToLocations1762841730079'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "locations" WHERE "user_id" IS NULL`);
        await queryRunner.query(`ALTER TABLE "locations" ALTER COLUMN "user_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "locations" ALTER COLUMN "address" DROP NOT NULL`);

        // Handle todos table - delete orphaned todos without user_id
        await queryRunner.query(`DELETE FROM "todos" WHERE "user_id" IS NULL`);
